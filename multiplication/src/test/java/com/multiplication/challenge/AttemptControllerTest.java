...
import com.multiplication.controller.AttemptController;
...
public class AttemptControllerTest {
    ...
    void postValidResult() throws Exception {
        ...
        long attemptId = 5L;
        AttemptDTO attemptDTO = new AttemptDTO(50, 70, "john", 3500);
        Attempt expectedResponse = new Attempt(attemptId, user, 50, 70, 3500, true);
    ...
    void postInvalidResult() throws Exception {
        ...
        AttemptDTO attemptDTO = new AttemptDTO(2000, -70, "john", 1);
